        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceText = table.Column<string>(maxLength: 250, nullable: true),
                    Title = table.Column<string>(maxLength: 100, nullable: false),
                    Subtitle = table.Column<string>(maxLength: 200, nullable: false),
                    BtnText = table.Column<string>(maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProducingPrice = table.Column<decimal>(type: "Money", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CampaignBooks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CampaignBooks_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CampaignBooks_Campaigns_CampaignId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CampaignBooks_BookId",
                table: "CampaignBooks",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_CampaignBooks_CampaignId",
                table: "CampaignBooks",
                column: "CampaignId");
        }
